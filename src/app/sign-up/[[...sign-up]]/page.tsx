    ...
    return (
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center mx-auto min-h-screen">
            ...
            <div className="flex flex-col items-center mb-8">
                ...
                <h1 className="text-3xl font-heading font-black text-slate-100">Create an Account</h1>
                <p className="text-slate-400 mt-2 text-center mb-8">Sign up to get started</p>
